...
data = pd.read_csv('csv/ohlcv_with_future.csv')

col = ['trend', 'RSI', 'close', 'Fast_Line', 'Slow_Line_9',
       'close_c_1min', 'close_1min', 'close_10min']
...
x_data = data[['close', 'Fast_Line', 'Slow_Line_9',
               'trend_uptrend', 'trend_downtrend', 'RSI']].copy()
